...
vim.api.nvim_create_autocmd("LspAttach", {
	callback = function(args)
		...
		--
		-- BLINK REPLACES THIS BLOCK ———————————————————————————————————————
		-- blink.cmp registers its own completion handler — enabling this
		-- alongside blink causes double-triggering. Toggle: ---[[ to --[[
		---[[
...
--
-- BLINK REPLACES THIS (comment out alongside completion.enable()) ——————————
-- Toggle: remove the outer vim.api.nvim_create_autocmd block below.
vim.api.nvim_create_autocmd("InsertCharPre", {
	callback = function()
...
--
-- BLINK REPLACES THIS BLOCK ————————————————————————————————————————————————
-- blink.cmp manages completeopt, pumheight, and pumblend internally.
